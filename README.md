# rdv-medical-mma
Application web de gestion de rendez-vous médicaux, développée dans le cadre du mini-projet Agile du module MMA.
[Edoc]((https://github.com/senanimed/rdv-medical-mma/) is a Simple web project that is made for e-channeling Using PHP,HTML & CSS.
...
7. Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/edoc-mma/
